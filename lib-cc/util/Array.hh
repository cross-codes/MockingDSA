...
struct Array {
 public:
  ...
  template <typename T>
    requires std::three_way_comparable<T>
  static void randomized_quick_sort(std::vector<T>& A,
                                    ptrdiff_t start,
                                    ptrdiff_t pastEnd) {
    while (start < pastEnd - 1) {
      ptrdiff_t q = randomized_partition_(A, start, pastEnd - 1);
  ...
  inline static auto stable_counting_sort(std::uint32_t A[],
                                          std::size_t n,
                                          uint32_t max)
  ...
  template <typename T>
    requires std::three_way_comparable<T>
  inline static auto index_binary_search(T a[],
                                         ptrdiff_t start,
                                         ptrdiff_t pastEnd,
  ...
  template <typename T>
    requires std::three_way_comparable<T>
  inline static auto index_ternary_search(T a[],
                                          ptrdiff_t start,
                                          ptrdiff_t pastEnd,
                                          const T& key) -> ptrdiff_t {
    ptrdiff_t i = start, j = pastEnd - 1;
  ...
  template <typename T>
    requires std::three_way_comparable<T>
  inline static auto inverse_order_statistic(T A[],
                                             ptrdiff_t start,
                                             ptrdiff_t pastEnd,
                                             std::size_t order) -> T {
  ...
  template <typename T>
    requires std::three_way_comparable<T>
  inline static auto order_statistic(T A[],
                                     ptrdiff_t start,
                                     ptrdiff_t pastEnd,
                                     std::size_t order) -> T {
  ...
  template <typename T>
    requires std::three_way_comparable<T>
  inline static auto order_statistic(std::vector<T>& A,
                                     ptrdiff_t start,
                                     ptrdiff_t pastEnd,
                                     std::size_t order) -> T {
    return inverse_order_statistic(A, start, pastEnd, pastEnd - start - order);
 ...
 private:
  ...
  template <typename T>
    requires std::three_way_comparable<T>
  inline static auto index_partition_(const std::vector<T>& A,
                                      ptrdiff_t p,
  ...
  template <typename T>
    requires std::three_way_comparable<T>
  static ptrdiff_t randomized_partition_(const std::vector<T>& A,
                                         ptrdiff_t p,
                                         ptrdiff_t r) {
    ptrdiff_t i = static_cast<ptrdiff_t>(random_.next_uniform_int<int>(
        static_cast<int>(p), static_cast<int>(r)));
  ...
  template <typename T>
    requires std::three_way_comparable<T>
  inline static auto lomuto_partition_(T nums[], ptrdiff_t p, ptrdiff_t r)
      -> T {
    ptrdiff_t mid = (p + r) >> 1;
  ...
  template <typename T>
    requires std::three_way_comparable<T>
  inline static auto lomuto_partition_(std::vector<T>& nums,
                                       ptrdiff_t p,
                                       ptrdiff_t r) -> T {
    ptrdiff_t mid = (p + r) >> 1;
    std::swap(nums[mid], nums[p + 1]);
