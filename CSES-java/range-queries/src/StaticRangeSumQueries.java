...
public class StaticRangeSumQueries extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new StaticRangeSumQueries(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    StaticPrefixSum prefix = new StaticPrefixSum(x);

    for (int i = 0; i < q; i++) {
      int a = in.nextInt(), b = in.nextInt();
      out.append(prefix.rangeSum(a - 1, b)).appendNewLine();
    }
  }

}

@MultipleInheritanceDisallowed(inheritor = StaticRangeSumQueries.class)
