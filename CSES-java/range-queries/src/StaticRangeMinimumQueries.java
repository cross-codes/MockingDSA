...
public class StaticRangeMinimumQueries extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new StaticRangeMinimumQueries(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    for (int i = 0; i < q; i++) {
      ...
      out.append(table.rangeQuery(a - 1, b)).appendNewLine();
    }
  }

}

@MultipleInheritanceDisallowed(inheritor = StaticRangeMinimumQueries.class)
