...
public class TrailingZeroes extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new TrailingZeroes(), "LaunchableDriver", 1048576L).start();
  }

  private void solveCase(int _case) {
    int n = in.nextInt(), d = 5, res = 0;
...
@MultipleInheritanceDisallowed(inheritor = TrailingZeroes.class)
