...
public class PointLocationTest extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new PointLocationTest(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    int dir = Line2D.relativeCCW(x1, y1, x2, y2, x3, y3);
    switch (dir) {
      case 1:
        out.append("RIGHT").appendNewLine();
        return;
      case -1:
        out.append("LEFT").appendNewLine();
        return;
      case 0:
        out.append("TOUCH").appendNewLine();
        return;
    }
...
@MultipleInheritanceDisallowed(inheritor = PointLocationTest.class)
