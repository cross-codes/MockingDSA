...
public class MessageRoute extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new MessageRoute(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    IntegerArrayList trace = new IntegerArrayList(n);
    ...
    for (int i = sz - 1; i >= 0; i--) {
      out.append(trace.get(i) + 1).append(" ");
    }
...
@MultipleInheritanceDisallowed(inheritor = MessageRoute.class)
