...
public class DistinctRoutes extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new DistinctRoutes(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    Edge[] Eparent = new Edge[adj.length];
    int[] visited = new int[adj.length], iteration = { 0 };
    ...
    for (int i = 0; i < maxFlow; i++) {
      ...
      out.append(path.size()).appendNewLine();
      for (int e : path) {
        out.append(1 + e).append(" ");
      }
      out.appendNewLine();
    }
  }
...
@MultipleInheritanceDisallowed(inheritor = DistinctRoutes.class)
