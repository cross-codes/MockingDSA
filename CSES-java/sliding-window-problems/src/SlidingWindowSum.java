...
public class SlidingWindowSum extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new SlidingWindowSum(), "LaunchableDriver", 1048576L).start();
  }
...
@MultipleInheritanceDisallowed(inheritor = SlidingWindowSum.class)
