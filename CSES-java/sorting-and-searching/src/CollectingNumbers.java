...
public class CollectingNumbers extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new CollectingNumbers(), "LaunchableDriver", 1048576L).start();
  }
...
@MultipleInheritanceDisallowed(inheritor = CollectingNumbers.class)
