...
public class MissingCoinSum extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new MissingCoinSum(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    for (int e : coins) {
      if (e > largest + 1) {
        out.append(largest + 1).appendNewLine();
        return;
      }
...
@MultipleInheritanceDisallowed(inheritor = MissingCoinSum.class)
