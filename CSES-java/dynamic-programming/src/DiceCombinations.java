...
public class DiceCombinations extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new DiceCombinations(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    out.append(ways[n]).appendNewLine();
  }

}

@MultipleInheritanceDisallowed(inheritor = DiceCombinations.class)
