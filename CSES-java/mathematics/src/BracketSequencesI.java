...
public class BracketSequencesI extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new BracketSequencesI(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    int denominator = Math.floorMod((long) inverseFactorial[n + 1] * inverseFactorial[n], MOD);
    out.append(Math.floorMod((long) factorial[n << 1] * denominator, MOD)).appendNewLine();
  }

}

@MultipleInheritanceDisallowed(inheritor = BracketSequencesI.class)
