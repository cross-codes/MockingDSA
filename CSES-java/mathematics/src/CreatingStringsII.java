...
public class CreatingStringsII extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new CreatingStringsII(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    int res = factorial[n];
    for (int f : freq) {
      res = Math.floorMod((long) res * inverseFactorial[f], MOD);
    }
...
@MultipleInheritanceDisallowed(inheritor = CreatingStringsII.class)
