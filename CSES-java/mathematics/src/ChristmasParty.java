...
public class ChristmasParty extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new ChristmasParty(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    out.append(D[n]).appendNewLine();
  }

}

@MultipleInheritanceDisallowed(inheritor = ChristmasParty.class)
