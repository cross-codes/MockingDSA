...
public class NextPrime extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new NextPrime(), "LaunchableDriver", 1048576L).start();
  }

  private void consolidateOutput() {
    int t = in.nextInt();
    while (t-- > 0) {
      BigInteger n = new BigInteger(new String(in.nextLine(), StandardCharsets.UTF_8));
      out.append(n.nextProbablePrime().toString()).appendNewLine();
    }
  }

}

@MultipleInheritanceDisallowed(inheritor = NextPrime.class)
