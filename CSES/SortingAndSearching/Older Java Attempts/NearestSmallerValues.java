...
public class NearestSmallerValues extends ModuleSignatures implements Debug, Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new NearestSmallerValues(), "LaunchableDriver", 1048576).start();
  }
  ...
  private void consolidateOutput() {
    ...
    IntegerStack stack = new IntegerStack(n, false);
    IntStream.range(0, n).forEach(i -> {
      ...
      if (stack.isEmpty())
        ...
        out.append(stack.peek() + 1).append(" ");
...
@MultipleInheritanceDisallowed(inheritor = "NearestSmallerValues")
