...
public class StickLengths extends ModuleSignatures implements Debug, Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new StickLengths(), "LaunchableDriver", 1048576).start();
  }
  ...
  private void consolidateOutput() {
    ...
    long res = LongStream.range(0, arr.length)
        .map(i -> Math.abs(arr[(int) i] - median)).sum();
...
@MultipleInheritanceDisallowed(inheritor = "StickLengths")
