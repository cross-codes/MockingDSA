...
public class NearestSmallerValues implements Runnable {

  InputReader in;
  OutputWriter out;

  public static void main(String[] args) {
    new Thread(null, new NearestSmallerValues(), "", 256 * (1L << 20)).start();
  }
  ...
  void solve() throws IOException {
    ...
    for (int i = 0; i < n; i++) {
      while (!stack.isEmpty() && arr[stack.peekLast()] >= arr[i]) stack.removeLast();

      if (stack.isEmpty()) out.append(0).append(" ");
      else out.append(stack.peekLast() + 1).append(" ");
