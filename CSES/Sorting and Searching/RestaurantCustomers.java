...
public class RestaurantCustomers implements Runnable {

  InputReader in;
  OutputWriter out;

  public static void main(String[] args) {
    new Thread(null, new RestaurantCustomers(), "", 256 * (1L << 20)).start();
  }
