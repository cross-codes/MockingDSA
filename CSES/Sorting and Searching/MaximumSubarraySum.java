...
public class MaximumSubarraySum implements Runnable {

  InputReader in;
  OutputWriter out;

  public static void main(String[] args) {
    new Thread(null, new MaximumSubarraySum(), "", 256 * (1L << 20)).start();
  }
  ...
  void solve() throws IOException {
    int n = in.nextInt();
    long currSum = 0, bestSum = Long.MIN_VALUE;
    ...
    out.append(bestSum).appendNewLine();
  }
