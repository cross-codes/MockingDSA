...
public class Repetitions extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new Repetitions(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    out.append(Math.max(cnt, mx)).appendNewLine();
  }

}

@MultipleInheritanceDisallowed(inheritor = Repetitions.class)
