...
public class IncreasingArray extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new IncreasingArray(), "LaunchableDriver", 1048576L).start();
  }

  private void solveCase(int _case) {
    int n = in.nextInt();

    int curmx = in.nextInt();
    long chg = 0L;
    ...
    out.append(chg).appendNewLine();
  }

}

@MultipleInheritanceDisallowed(inheritor = IncreasingArray.class)
