...
public class NumberSpiral extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new NumberSpiral(), "LaunchableDriver", 1048576L).start();
  }

  private void solveCase(int _case) {
    final long y = in.nextInt(), x = in.nextInt();
    final long r = Math.max(y, x) - 1;
...
@MultipleInheritanceDisallowed(inheritor = NumberSpiral.class)
