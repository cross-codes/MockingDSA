...
public class MovieFestival extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new MovieFestival(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    Arrays.sort(intervals, Comparator.comparingInt((int[] a) -> a[1]).thenComparing(a -> a[0]));
    int lend = Integer.MIN_VALUE, cnt = 0;
    for (int i = 0; i < n; i++) {
...
@MultipleInheritanceDisallowed(inheritor = MovieFestival.class)
