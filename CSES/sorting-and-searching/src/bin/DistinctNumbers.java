...
public class DistinctNumbers extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new DistinctNumbers(), "LaunchableDriver", 1048576L).start();
  }

  private void solveCase(int _case) {
    int n = in.nextInt();
    out.append(IntStream.range(0, n).map(i -> in.nextInt()).distinct().count()).appendNewLine();
  }

}

@MultipleInheritanceDisallowed(inheritor = DistinctNumbers.class)
