...
public class DistributingApples implements Runnable {

  InputReader in;
  OutputWriter out;

  public static void main(String[] args) {
    new Thread(null, new DistributingApples(), "", 256 * (1L << 20)).start();
  }
  ...
  void solve() throws IOException {
    ...
    int[] factorials = new int[n + m];
    int[] inverseFactorials = new int[Math.max(n, m) + 1];
    ...
    long res = (long) factorials[n + m - 1] * inverseFactorials[n - 1] % MOD * inverseFactorials[m] % MOD;
