...
public class CoinPiles implements Runnable {

  InputReader in;
  OutputWriter out;

  public static void main(String[] args) {
    new Thread(null, new CoinPiles(), "", 256 * (1L << 20)).start();
  }
  ...
  void solve() throws IOException {
    ...
    while (t-- > 0) {
      ...
      if ((2L * b - a) >= 0
          && ((2L * b - a) % 3L == 0L)
          && (2L * a - b) >= 0
          && ((2L * a - b) % 3L == 0L)) out.append("YES").appendNewLine();
      else out.append("NO").appendNewLine();
    }
  }
