...
public class _2062A extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2062A(), "LaunchableDriver", 1048576L).start();
  }
...
@MultipleInheritanceDisallowed(inheritor = _2062A.class)
