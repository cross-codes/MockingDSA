...
public class _2037A extends ModuleSignatures implements Debug, Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2037A(), "LaunchableDriver", 1048576).start();
  }
...
@MultipleInheritanceDisallowed(inheritor = "_2037A")
