...
public class _2051E extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2051E(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void consolidateOutput() {
    ...
    while (t-- > 0) {
      ...
      int[] b = in.readIntegerArray(n);

      PriorityQueue<OrderedPair<Integer, Integer>> queue = new PriorityQueue<>(Comparator.reverseOrder());

      for (int i = 0; i < n; i++) {
        OrderedPair<Integer, Integer> pair = new OrderedPair<>(a[i], b[i]);
        queue.add(pair);
      }
    }
  }
...
@MultipleInheritanceDisallowed(inheritor = _2051E.class)
