...
public class _2051A extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2051A(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void consolidateOutput() {
    ...
    while (t-- > 0) {
      int n = in.nextInt();
      int[] m = in.readIntegerArray(n);
      int[] s = in.readIntegerArray(n);
      ...
      out.append(diff).appendNewLine();
    }
  }

}

@MultipleInheritanceDisallowed(inheritor = _2051A.class)
