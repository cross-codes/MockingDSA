...
public class _2014D implements Runnable {

  InputReader in;
  OutputWriter out;

  public static void main(String[] args) {
    new Thread(null, new _2014D(), "", 256 * (1L << 20)).start();
  }
  ...
  void solve() {
    ...
    while (t-- > 0) {
      ...
      sb.append(maxSumStart).append(" ").append(minSumStart).append("\n");
    }
