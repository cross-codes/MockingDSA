...
public class _2036B extends Functions implements Debug, Runnable {
  ...
  public static void main(String[] args) {
    new Thread(null, new _2036B(), "Solution", 1048576).start();
  }
...
@MultipleInheritanceDisallowed(inheritor = "_2036B")
