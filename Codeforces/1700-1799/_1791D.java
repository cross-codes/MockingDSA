...
public class _1791D implements Runnable {

  InputReader in;
  OutputWriter out;

  public static void main(String[] args) {
    new Thread(null, new _1791D(), "", 256 * (1L << 20)).start();
  }
  ...
  void solve() throws IOException {
    ...
    while (t-- > 0) {
      int n = in.nextInt();
      byte[] s = in.next();
      boolean[] markerA = new boolean[26];
      boolean[] markerB = new boolean[26];
      int fA = 0, fB = 0;
      int split = n;
      ...
      out.append(fA + fB).appendNewLine();
    }
  }
