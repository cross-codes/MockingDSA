...
public class _2175A extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2175A(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    Integer ceil = a.ceiling(a.size());
    out.append(ceil == null ? a.size() : ceil).appendNewLine();
  }

}

@MultipleInheritanceDisallowed(inheritor = _2175A.class)
