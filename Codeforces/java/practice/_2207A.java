...
public class _2207A extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2207A(), "LaunchableDriver", 1048576L).start();
  }

  private void solveCase(int _case) {
    int n = in.nextInt();
    byte[] s = in.next(), s1 = s.clone();
    ...
    out.append(mn).append(" ").append(mx).appendNewLine();
  }

}

@MultipleInheritanceDisallowed(inheritor = _2207A.class)
