...
public class _2132B extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2132B(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    out.append(list.size()).appendNewLine();
    if (list.size() > 0) {
      for (long e : list) {
        out.append(e).append(" ");
      }
...
@MultipleInheritanceDisallowed(inheritor = _2132B.class)
