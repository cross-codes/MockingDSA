...
public class _668948A extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _668948A(), "LaunchableDriver", 1048576L).start();
  }

  private void solveCase(int _case) {
    int n = in.nextInt();
    for (int i = 1; i <= n; i++) {
      out.append(i * i).append(" ");
    }
...
@MultipleInheritanceDisallowed(inheritor = _668948A.class)
