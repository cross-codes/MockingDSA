...
public class _2202B extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2202B(), "LaunchableDriver", 67108864L).start();
  }
...
@MultipleInheritanceDisallowed(inheritor = _2202B.class)
