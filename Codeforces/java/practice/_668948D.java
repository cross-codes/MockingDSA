...
public class _668948D extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _668948D(), "LaunchableDriver", 1048576L).start();
  }

  private void solveCase(int _case) {
    int x = in.nextInt(), y = in.nextInt(), a = in.nextInt(), b = in.nextInt();

    int bb = b * b, aa = a * a, bx = b * x, ay = a * y, by = b * y, ax = a * x;

    if ((bb == aa) || (bx - ay) % (bb - aa) != 0 || (by - ax) % (bb - aa) != 0) {
    ...
    out.append(m1 + m2).appendNewLine();
  }

}

@MultipleInheritanceDisallowed(inheritor = _668948D.class)
