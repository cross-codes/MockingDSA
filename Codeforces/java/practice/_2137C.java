...
public class _2137C extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2137C(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    if ((b & 1) == 0) {
      ...
      if (gp == 2) {
        if ((a & 1) == 0) {
          out.append(a * (b >>> 1) + 2).appendNewLine();
        } else {
      ...
      if ((a & 1) == 0) {
        ...
        out.append(a * b + 1).appendNewLine();
      }
    }
  }
...
@MultipleInheritanceDisallowed(inheritor = _2137C.class)
