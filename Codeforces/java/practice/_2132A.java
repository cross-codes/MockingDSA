...
public class _2132A extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2132A(), "LaunchableDriver", 1048576L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    String c = new String(in.next(), StandardCharsets.US_ASCII);
...
@MultipleInheritanceDisallowed(inheritor = _2132A.class)
