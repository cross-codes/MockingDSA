...
public class _668948B extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _668948B(), "LaunchableDriver", 1048576L).start();
  }

  private void solveCase(int _case) {
    int A = in.nextInt(), b = in.nextInt();
    out.append(A / b).appendNewLine();
  }

}

@MultipleInheritanceDisallowed(inheritor = _668948B.class)
