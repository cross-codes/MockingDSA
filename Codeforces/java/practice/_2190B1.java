...
public class _2190B1 extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2190B1(), "LaunchableDriver", 67108864L).start();
  }
  ...
  private void solveCase(int _case) {
    ...
    if (j == -1) {
      ...
      out.append(n - 2).appendNewLine();
    }

  }
}

@MultipleInheritanceDisallowed(inheritor = _2190B1.class)
