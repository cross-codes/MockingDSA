...
public class _2193F extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2193F(), "LaunchableDriver", 1048576L).start();
  }
...
@MultipleInheritanceDisallowed(inheritor = _2193F.class)
