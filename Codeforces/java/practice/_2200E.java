...
public class _2200E extends ModuleSignatures implements Runnable {
  ...
  public static void main(String... args) {
    new Thread(null, new _2200E(), "LaunchableDriver", 67108864L).start();
  }
...
@MultipleInheritanceDisallowed(inheritor = _2200E.class)
