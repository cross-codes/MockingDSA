...
public class _1411B implements Runnable {

  InputReader in;
  OutputWriter out;

  public static void main(String[] args) {
    new Thread(null, new _1411B(), "", 256 * (1L << 20)).start();
  }
  ...
  void solve() throws IOException {
    ...
    while (t-- > 0) {
      ...
      increment:
      while (true) {
        String numRepr = String.valueOf(n);
        for (int i = 0; i < numRepr.length(); i++) {
          int digit = Character.getNumericValue(numRepr.charAt(i));
