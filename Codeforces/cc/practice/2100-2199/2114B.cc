...
auto run() -> void
{
  ...
  int num_zeroes = static_cast<int>(std::count(s.begin(), s.end(), '0'));
  int num_ones   = static_cast<int>(std::count(s.begin(), s.end(), '1'));

  int max_pairs  = num_zeroes / 2 + num_ones / 2;
  int min_pairs  = std::abs(num_zeroes / 2 - num_ones / 2);
  ...
  // int matching_ones{}, matching_zeroes{};
  // int l{}, r{n - 1};
  //
  // while (l < r)
  // {
  ...
  // }
  //
  // int total_matches{matching_ones + matching_zeroes};
  //
  // if (total_matches == k)
  // {
  //   io::cout << "YES\n";
  ...
  // }
  //
  // int min_matches = std::min(matching_ones, matching_zeroes);
  // if (k > total_matches)
  // {
  //   if ((k - total_matches) & 1)
  //     io::cout << "NO\n";
  //   else
  //   {
  //     int diff = k - total_matches;
  //     if (diff / 2 <= min_matches)
  //       io::cout << "YES\n";
  //     else
  //       io::cout << "NO\n";
  //   }
  ...
  // else
  // {
  //   if ((total_matches - k) & 1)
  //     io::cout << "NO\n";
  //   else
  //   {
  //     int diff = total_matches - k;
  //     if (diff / 2 <= min_matches)
  //       io::cout << "YES\n";
  //     else
  //       io::cout << "NO\n";
