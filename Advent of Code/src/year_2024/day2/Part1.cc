...
int32_t main() {
  int32_t numberOfSafeLevels = 0;

  std::string stringStream = "0";

  io.read_string(stringStream);

  cout << stringStream;

  /*do {*/
  /*  cin >> stringStream;*/
  /*  auto vec = split(stringStream, " ");*/
  /**/
  /*  if (vec.size() == 1) {*/
  /*    numberOfSafeLevels++;*/
  /*    continue;*/
  /*  }*/
  /**/
  /*  std::vector<int32_t> numbers(vec.size());*/
  /**/
  /*  std::transform(vec.begin(), vec.end(), std::back_inserter(numbers),*/
  /*                 [](const std::string &str) { return std::stoi(str); });*/
  /**/
  /*  for (int32_t val : numbers)*/
  /*    cout << val;*/
  /**/
  /*} while (!stringStream.empty());*/
